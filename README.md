...
[![shipthatcode — SQL Advanced](https://api.shipthatcode.com/cert/60b150c53c6abb16596d3c5ca21a1b8b.svg)](https://shipthatcode.com/courses/sql-advanced)

My working repo for [SQL Advanced](https://shipthatcode.com/courses/sql-advanced) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start SQL Advanced"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/sql-advanced) ("Work in your own editor" → **Link repo**). Done — you never do this again.
...
Courses improve over time — exercises get added, tests get fixed. If the [course page](https://shipthatcode.com/courses/sql-advanced) says your starter is out of date: download a fresh zip, **delete this repo's `tests/` folder entirely**, copy in the fresh `tests/` and `.shipthatcode.json`, and keep your own code exactly as it is. (Don't merge test folders — lesson numbering can shift between versions.) Lessons you've already completed stay completed either way.
